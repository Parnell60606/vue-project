import{U as k,h as g,i as u,c3 as w,j as y,k as T,u as $,l as S,m as h,n as B,bF as N,q as c,bA as L,a2 as O,E as R,ap as V,_ as I,c4 as H,c5 as P,aK as W,c6 as j,c7 as D,o as v,c as E,d as f,a as _,w as l,F,c8 as K,c9 as M,x as q,aG as A,ca as G,g as p,aJ as b,p as J,b as U,f as X}from"./index.3e89773f.js";const Y=e=>{const{opacityDisabled:o,heightTiny:n,heightSmall:t,heightMedium:r,heightLarge:i,heightHuge:s,primaryColor:a,fontSize:d}=e;return{fontSize:d,textColor:a,sizeTiny:n,sizeSmall:t,sizeMedium:r,sizeLarge:i,sizeHuge:s,color:a,opacitySpinning:o}},Q={name:"Spin",common:k,self:Y},Z=Q,ee=g([g("@keyframes spin-rotate",`
 from {
 transform: rotate(0);
 }
 to {
