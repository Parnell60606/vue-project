import{S as f,k as y,l,j as d,n as m,m as v,u as b,q as a,s as C,bq as $,t as h,O as _,Z as z}from"./index.2b2ecb9b.js";const D=e=>{const{textColorBase:o,opacity1:i,opacity2:s,opacity3:c,opacity4:n,opacity5:t}=e;return{color:o,opacity1Depth:i,opacity2Depth:s,opacity3Depth:c,opacity4Depth:n,opacity5Depth:t}},S={name:"Icon",common:f,self:D},x=S,R=y("icon",`
 height: 1em;
 width: 1em;
 line-height: 1em;
 text-align: center;
